...
from fusion_modules import ActionProjector, FiLM
...
from .configuration_dexvla import DexVLAConfig, Qwen2VLAVisionConfig
import gc
...
class Qwen2VLRotaryEmbedding(nn.Module):
    def __init__(
        ...
        scaling_factor=1.0,
        rope_type="default",
        config: Optional[DexVLAConfig] = None,
    ):
        super().__init__()
...
class Qwen2VLAttention(nn.Module):
    ...
    def __init__(self, config: DexVLAConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class Qwen2VLDecoderLayer(nn.Module):
    def __init__(self, config: DexVLAConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class Qwen2VLModel(Qwen2VLPreTrainedModel):
    def __init__(self, config: DexVLAConfig):
        super().__init__(config)
...
class DexVLAPolicy(Qwen2VLPreTrainedModel, GenerationMixin):
